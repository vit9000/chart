...
public:
	...
	virtual void addDrug(const ID& id, int type, const DrugInfo& drugInfo, const map<int, Unit>& units, int pos) = 0;
	...
	virtual void moveDrug(const ID& id, int new_pos, bool redraw = true) = 0;
